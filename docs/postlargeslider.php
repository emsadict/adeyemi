    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["error"] === 0) {
        ...
        if (in_array($image_type, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                ...
                if ($conn->query($query)) {
                    echo "<script>alert('Image uploaded successfully!'); window.location='postlargeslider.php';</script>";
                } else {
            ...
            <div class="kingster-page-title-wrap  kingster-style-medium kingster-center-align">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr">
                        <h1 class="kingster-page-title">POST SLIDER</h1></div>
                </div>
            </div>
...
<?php endif; ?>
        ...
        <Center> <h2>Post Picture to large slider</h2></Center>
                    <div class="form-container">
             <form action="postlargeslider.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
