            ...
            <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(uploads/<?php echo htmlspecialchars($page['dept_picture']); ?>) ; height:400px;">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 100px ;padding-bottom: 60px ;">
                        <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">OFFICE OF THE VICE CHANCELLOR</h1></div>
                </div>
            </div>
            <div class="kingster-breadcrumbs">
                <div class="kingster-breadcrumbs-container kingster-container">
                    <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="index.php" class="home"><span property="name">Home</span></a>
                        ...
                        </span>&gt;<span property="itemListElement" typeof="ListItem"><span property="name">VCO</span>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;"></h3></div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                ...
                                <div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
                                    <div id="text-15" class="widget widget_text kingster-widget">
                                        ...
                                        <div class="gdlr-core-video-widget gdlr-core-media-image">
                                            <a class="gdlr-core-lightgallery gdlr-core-js " style="border-width: 10px;"><img src="images/new_vc.jpg" width="400" height="400"   alt="" /></a>
                                            <h5 style="margin-bottom:2px;font-size: 20px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color:rgb(8, 56, 45) ; text-align:center;">Prof. Samuel Akintunde
                                                        ...
                                                        <p style="margin-bottom: 5px;font-size: 18px ;font-weight: 200 ;color:rgb(61, 184, 155) ; text-align:center;">Vice Chancellor
                                                    </p> 
                                        ...
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                            <div class="gdlr-core-widget-box-shortcode " style="color: #ffffff ;padding: 10px 25px;background-color:rgb(8, 59, 53) ;">
                                                <div class="gdlr-core-widget-box-shortcode-content">
                                                    ...
                                                    <p><span style="color:rgb(255, 255, 255); font-size: 16px; font-weight: 600;">Office of the The  Vice Chancellor    </span>
                                                        <br /> <span style="font-size: 15px;"><br /> Adeyemi Federal University of Education(AFUED), Ondo<br /> Ondo State Nigeria</span></p>
                                                    <p style="font-size: 15px;"><a href="tel:" style="color: #ffffff; text-decoration: none;">Phone:</a><br /><strong style="color: #ffffff;">Email:</strong><a href="mailto:...." style="color: #ffffff; text-decoration: none;">....</a></p>
