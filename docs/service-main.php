           ...
           <?php   include "menu.php";?>
            ...
            <div class="kingster-page-wrapper" id="kingster-page-wrapper">
                <div class="gdlr-core-page-builder-body">
                    <div class="gdlr-core-pbf-sidebar-wrapper " style="margin: 0px 0px 10px 0px;">
                        <div class="gdlr-core-pbf-sidebar-container gdlr-core-line-height-0 clearfix gdlr-core-js gdlr-core-container">
                            <div class="gdlr-core-pbf-sidebar-content  gdlr-core-column-40 gdlr-core-pbf-sidebar-padding gdlr-core-line-height gdlr-core-column-extend-right" style="padding: 35px 0px 10px 0px;">
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                                <p style="text-align: justify;">It gives me great pleasure writing this welcome message to all stakeholders of the University of Medical Sciences (UNIMED), 
                                                    at Ondo City, Ondo State, Nigeria. With the development of Information Technology (IT), there has been a significant change in the 
                                                    delivery of medical education and medical service. IT is now an indispensable tool for driving all these services.
                                                    .</p>
                                                    <p style="text-align: justify;">The Vision of the Information and Communication Technology (ICT) Centre is “to be a world class 
                                                        Information Technology Service Centre promoting health care, education, research, and service delivery.” Our Mission is
                                                         “to be committed to the implementation of cost-effective solutions that enhances quality education for students and gives
                                                          administrators and faculty the means to operate effectively and efficiently.”
                                                    </p> 
                                                      <button  style="background-color:red; width: 100px; height:50px; border: none;"><a href="#objective1" style="color:white;text-decoration: none;border: none; ">READ MORE</a></button>
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-feature-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align">
                                                        <div class="gdlr-core-feature-box gdlr-core-js gdlr-core-feature-box-type-outer" style="background-color:#144a27 ;border-width: 0px 0px 0px 0px;border-radius: 3px;-moz-border-radius: 3px;-webkit-border-radius: 3px;">
                            ...
                            <div class="gdlr-core-pbf-sidebar-left gdlr-core-column-extend-right  kingster-sidebar-area gdlr-core-column-20 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height" style="padding: 35px 0px 30px 0px;">
                                ...
                                <div class="gdlr-core-divider-line gdlr-core-skin-divider" style="border-color:rgb(10, 3, 71) ;border-bottom-width: 3px ;"></div>
                                        ...
                                        <div class="gdlr-core-tab-item-wrap">
                                            <div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font">
                                                ...
                                                <div class="gdlr-core-tab-item-title " data-tab-id="3">Staff Directory</div>
                                               
                                                <div class="gdlr-core-tab-item-title " data-tab-id="4">Contact Details</div>
                                            </div>
                                            <div class="gdlr-core-tab-item-content-wrap clearfix">
                                                ...
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top">
                                                    ...
                                                    <p style="text-align: justify;" id="objective1" >It gives me great pleasure writing this welcome message to all stakeholders of the University of Medical Sciences (UNIMED), 
                                                    at Ondo City, Ondo State, Nigeria. With the development of Information Technology (IT), there has been a significant change in the 
                                                    delivery of medical education and medical service. IT is now an indispensable tool for driving all these services.
                                                    .</p>
                                                    <p style="text-align: justify;">The Vision of the Information and Communication Technology (ICT) Centre is “to be a world class 
                                                    ...
                                                    <p style="text-align: justify;">Several visiting accreditation bodies have adjudged the ICT Centre as a great asset in contributing to learning and teaching in UNIMED.</p>
                                               ...
                                               <p></p> 
                                                ...
                                                <div class="gdlr-core-tab-item-content " data-tab-id="3" >
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top">
                                                        <div class="gdlr-core-title-item-title-wrap ">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " id="h3_1dd7_26">Staff Directory<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider" ></span></h3></div>
                                                    </div>
