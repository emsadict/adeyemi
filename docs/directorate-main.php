            ...
            <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/about-title-bg.jpg) ;">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 400px ;padding-bottom: 60px ;">
                        <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Research Centres</h1></div>
                </div>
            </div>
            ...
            <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: none;">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 10px ;padding-bottom: 0px ;">
                        ...
                        <h1 class="kingster-page-title" style="font-size: 45px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color:rgb(11, 0, 60) ;">Central Office for Research and Development (CORD)</h1></div>
                </div>
            </div>
                                    ...
                                    <div class="gdlr-core-blog-item-holder gdlr-core-js-2 clearfix" data-layout="fitrows">
                                        <div class="gdlr-core-item-list  gdlr-core-item-pdlr gdlr-core-item-mgb gdlr-core-column-15">
                                            <div class="gdlr-core-blog-modern  gdlr-core-with-image  ">
                                                    ...
                                                    <div class="gdlr-core-image-item-wrap gdlr-core-media-image  gdlr-core-image-item-style-rectangle" style="border-width: 0px;">
                                                        <a class="gdlr-core-lightgallery gdlr-core-js " href="upload/59.jpg"><img src="upload/59.jpg" width="377" height="150" alt="" /><span class="gdlr-core-image-overlay "></span></a>
                                                        
                                                    </div> 
                                                    <p style="margin-bottom:5px;font-size: 20px ;font-weight: 400 ;letter-spacing: 0px ;text-transform: none ;color:rgb(15, 13, 41) ; text-align:center;">Oyeyemi Oyetunde Timothy</p>
                                                        <p style="margin-bottom: 5px;font-size: 18px ;font-weight: 200 ;color:rgb(15, 13, 41) ; text-align:center;">B.Sc, M. Sc, Ph.D</p> 
                                                        <p style="font-size: 18px ;font-weight: 200 ;color:rgb(15, 13, 41) ; text-align:center;"> Director</p>
                                            </div>
                                        </div>
                                        <div class="gdlr-core-item-list  gdlr-core-item-pdlr gdlr-core-item-mgb gdlr-core-column-40">
                                            <div class="gdlr-core-blog-modern  gdlr-core-with-image gdlr-core-hover-overlay-content gdlr-core-opacity-on-hover ">
                                                ...
                                                <a class="gdlr-core-lightgallery gdlr-core-js " href="upload/59.jpg"><img src="upload/ict.jpg" width="850" height="100" alt="" /></a>
                                            ...
                                            <div class="gdlr-core-tab-item-content-wrap clearfix">
                                                ...
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top">
                                                    ...
                                                    <p style="text-align: justify;">In the university context, the academic community bears substantial responsibility for leading impactful research endeavours. 
                                                       ...
                                                       <p style="text-align: justify;">Moreover, CORD is deeply invested in the capacity development of researchers, 
                                                                aiming to equip them with the essential skills, knowledge, and competencies needed for contemporary research. 
                                                                This involves organizing workshops, seminars, and training programmes that address the
                                                                 evolving needs of researchers across diverse disciplines.
                                                       </p>
                                                       <p style="text-align: justify;">In tandem with this commitment, CORD actively promotes the adoption of best academic practices, serving as a hub 
                                                                    for disseminating information about innovative methodologies, ethical standards, and effective research practices. 
                                                                    By fostering a culture of continuous improvement and adherence to the highest standards of academic integrity, 
                                                                    CORD seeks to elevate the quality and impact of research from the university.
                                                        </p>
                                                        <p style="text-align: justify;">Beyond academia, CORD recognizes its broader societal responsibility, 
                                                                    committed to advancing societal development through a spectrum of research initiatives addressing
                                                                     pressing challenges and contributing to community betterment. 
                                                                    This outreach underscores the Center's commitment to harnessing the transformative power of research for the greater good.
                                                        </p>
